...
class CompanyActivityArea
{
    ...
    public function addCompany(Company $company): self
    {
        if (!$this->companies->contains($company)) {
            ...
            $company->setIdActivityArea($this);
        }
    ...
    public function removeCompany(Company $company): self
    {
        if ($this->companies->contains($company)) {
            ...
            if ($company->getIdActivityArea() === $this) {
                $company->setIdActivityArea(null);
            }
        }
    ...
    public function addParameter(Parameter $parameter): self
    {
        if (!$this->parameters->contains($parameter)) {
            ...
            $parameter->setCompanyActivityArea($this);
        }
    ...
    public function removeParameter(Parameter $parameter): self
    {
        if ($this->parameters->contains($parameter)) {
            ...
            // set the owning side to null (unless already changed)
            if ($parameter->getCompanyActivityArea() === $this) {
                $parameter->setCompanyActivityArea(null);
            }
        }
