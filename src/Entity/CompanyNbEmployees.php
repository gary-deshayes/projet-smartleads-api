...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CompanyNbEmployeesRepository")
 */
class CompanyNbEmployees
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Parameter", mappedBy="companyNbEmployees")
     */
    private $parameters;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Company", mappedBy="companyNbEmployees")
     */
    private $companies;
