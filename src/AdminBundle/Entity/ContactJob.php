...
class ContactJob
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\AdminBundle\Entity\Contact", mappedBy="idJob")
     */
    private $contacts;

    /**
     * @ORM\ManyToMany(targetEntity="App\AdminBundle\Entity\Parameter", mappedBy="contactjobs")
     */
    private $parameters;
