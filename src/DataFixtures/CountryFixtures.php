...
class CountryFixtures extends BaseFixture
{
    ...
    public function __construct()
    {
        ...
        $this->keys = array_keys($this->countries);
        $this->values = array_values($this->countries);
    }
    public function loadData(ObjectManager $manager)
    {
        $this->createMany(count($this->countries), "Country", function ($count) {
            $country = new Country();
            $country->setCode($this->values[$count][2]);
            $country->setLibelle($this->values[$count][3]);
            return $country;
        });
