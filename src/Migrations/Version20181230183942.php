 ...
 */
final class Version20181230183942 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, id_job_id INT DEFAULT NULL, user_id INT DEFAULT NULL, company_id INT DEFAULT NULL, code_customer VARCHAR(255) NOT NULL, gender VARCHAR(1) NOT NULL, first_name VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, date_created_plug DATETIME NOT NULL, date_update_plug DATETIME NOT NULL, status TINYINT(1) DEFAULT NULL, decision_level INT DEFAULT NULL, birth_date DATETIME DEFAULT NULL, job VARCHAR(255) DEFAULT NULL, mobile_phone VARCHAR(10) DEFAULT NULL, phone VARCHAR(10) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, email_prechecked TINYINT(1) DEFAULT NULL, email_checked TINYINT(1) DEFAULT NULL, url_linkedin VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, operation_source VARCHAR(255) DEFAULT NULL, commentary VARCHAR(255) DEFAULT NULL, opt_in_newsletter TINYINT(1) NOT NULL, opt_in_offer_commercial TINYINT(1) NOT NULL, company_function VARCHAR(255) NOT NULL, company_service VARCHAR(255) NOT NULL, INDEX IDX_4C62E6382DD7FB44 (id_job_id), INDEX IDX_4C62E638A76ED395 (user_id), INDEX IDX_4C62E638979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
